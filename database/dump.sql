...
6	Logitech G910	19999	/images/logitechG910.png	The highest levels performance, engineering, and design. G910 is fully loaded with programmable G-keys, LIGHTSYNC RGB, Romer-G Tactile switches, integrated palm rest and more.	Maintain full control of your gaming commands with the customizable, illuminated keys on this Orion Spectrum mechanical gaming keyboard. Connect the unit to a smartphone or tablet to display in-game information when you need a second screen. Anti-ghosting protection keeps the Orion Spark mechanical gaming keyboard from freezing up during intense gaming sessions.
\.
